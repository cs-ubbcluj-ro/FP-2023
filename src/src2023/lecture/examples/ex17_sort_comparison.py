...
from ex13_insertion_sort import insertion_sort, binary_insertion_sort
from ex14_merge_sort import merge_sort
from ex16_tim_sort_ver_a import tim_sort_rpython
from ex16_tim_sort_ver_b import tim_sort_vladris

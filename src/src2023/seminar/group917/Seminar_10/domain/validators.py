from src2023.seminar.group917.Seminar_10.domain.domain_exceptions import ValidationException, TaskValidationException, \
    PersonValidationException, AssignmentValidationException
